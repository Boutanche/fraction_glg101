...
public class TestFraction {
     ...
     *   | Numérateur          | MIN_VALUE |  NUMERATEUR_NÉGATIF  |  0  | NUMERATEUR_POSITIF |
     *   |---------------------|-----------|----------------------|-----|--------------------|
     *   | Dénominateur        |-----------|----------------------|-----|--------------------|
     *   |_____________________|___________|______________________|_____|____________________|
     *   | MIN_VALUE           | IAE       |        IAE           | IAE |       IAE          |
     *   |_____________________|___________|______________________|_____|____________________|
     *   |DENOMINATEUR_NÉGATIF | IAE       |        NN            |  Z0 |       PN           |
     *   |_____________________|___________|______________________|_____|____________________|
     *   |      0              | AE        |        AE            |  AE |       AE           |
     *   |_____________________|___________|______________________|_____|____________________|
     *   |      1              | IAE       |    FractionInt       |  Z0 |  FractionInt       |
     *   |_____________________|___________|______________________|_____|____________________|
     *   |DENOMINATEUR_POSITIF | IAE       |        NP            |  Z0 |                    |
     *   |_____________________|___________|______________________|_____|____________________|
     *
